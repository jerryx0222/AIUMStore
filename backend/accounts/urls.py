...
from .views import (
    ...
    MeView,
    RegisterView,
    StoreClerkDetailView,
    StoreClerkListCreateView,
...
urlpatterns = [
    ...
    path(
        "franchise-masters/<int:pk>/franchised-brands/",
        FranchiseMasterBrandsView.as_view(),
        name="franchise-master-franchised-brands",
    ),
    ...
    path("store-clerks/", StoreClerkListCreateView.as_view(), name="store-clerk-list"),
    path("store-clerks/<int:pk>/", StoreClerkDetailView.as_view(), name="store-clerk-detail"),
]
